...
def us_ecom_pipeline():
    ...
    def check_for_file_from_Retailer_to_organisation(**kwargs):
        ...
        df = pd.read_csv(Retailer_file_path_name)
        ti=kwargs['ti']
    ...
    def move_file_from_data_to_intermediate_storage(**kwargs):
        ...
        return "File moved to Intermediat_Storage"
    ...
    def transform_data(**kwargs):
        ...
        df = pd.read_csv(destination_path_file_name)
    ...
    def load_data_into_warehouse_db(**kwargs):
        import pandas as pd
        import
        transformed_path_file_name = kwargs['ti'].xcom_pull(key="transformed_path_file_name",
                                                            task_ids="transform_data")
        df = pd.read_csv(transformed_path_file_name)
        return "Data loaded into Warehouse"
    @task
    def move_file_from_intermediate_to_backup():
        pass
    ...
    check_for_file_from_Retailer_to_organisation >> move_file_from_data_to_intermediate_storage >> transform_data >> load_data_into_warehouse >> move_file_from_intermediate_to_backup
